...
selectionNode = null; //Points to the new node that was created to hold the selected text.
done = false; //Indicates whether all of the selection is processed or not. Once this becomes true, no more processing has to be done. The remianing nodes can be appended without processing.
content = ""; //holds the full content of the root node without any tags. only html.
operationMode = "reset";
